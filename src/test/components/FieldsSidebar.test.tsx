...
describe('FieldsSidebar', () => {
  const fieldA: PlacedField = {
    id: 'f1', fieldName: 'name', x: 10, y: 20, page: 1,
    font: 'Helvetica', fontSize: 14, color: '#000', isBold: false, isItalic: false,
    width: 30, align: 'left', visible: true,
  };
  const fieldB: PlacedField = {
    id: 'f2', fieldName: 'email', x: 30, y: 40, page: 1,
    font: 'Helvetica', fontSize: 12, color: '#000', isBold: false, isItalic: false,
    width: 30, align: 'left', visible: true,
  };
  ...
  it('shows placed fields count badge', () => {
    renderWithProvider(<FieldsSidebar {...baseProps} placedFields={[fieldA, fieldB]} />);
